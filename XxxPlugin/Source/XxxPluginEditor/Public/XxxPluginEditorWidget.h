...
#include "XxxPluginEditorWidget.generated.h"
...
UCLASS()
class XXXPLUGINEDITOR_API UXxxPluginEditorWidget : public UEditorUtilityWidget
{
	GENERATED_BODY()
...
public:
	...
	/**
	 * Callbacks to be binded to the XxxPluginEditor methods.
	 */
