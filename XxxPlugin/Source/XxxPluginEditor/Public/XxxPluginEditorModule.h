...
class XXXPLUGINEDITOR_API FXxxPluginEditorModule : public IModuleInterface, public FGCObject
{
...
private:
	...
	// Editor object.
	class UXxxPluginEditorBase* Editor;
	...
	FDelegateHandle OnRegisterStartupCallbackHandle;

	void OnRegisterStartupCallback();
	void ExtendToobarMenu();
	TSharedRef<SWidget> GenerateGameToolsMenu();
	static void TestAction1();

	TSharedRef<SDockTab> OnSpawnPluginTabXxxPluginMoreActions(const FSpawnTabArgs& SpawnTabArgs);
};
